...
func ServiceAccounts(data dash.ServiceAccountsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, sa := range data.ServiceAccounts {
			...
			templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.ResolveAttributeValue(sa.ID)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.ResolveAttributeValue(sa.ID)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.ResolveAttributeValue(sa.Status)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.ResolveAttributeValue(sa.ID)
			if templ_7745c5c3_Err != nil {
		...
		for _, user := range data.AvailableUsers {
			...
			templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.ResolveAttributeValue(user)
			if templ_7745c5c3_Err != nil {
